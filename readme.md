# [![Java CI with Maven](https://github.com/sljiang93/spring-petclinic/actions/workflows/maven.yml/badge.svg)](https://github.com/sljiang93/spring-petclinic/actions/workflows/maven.yml)
